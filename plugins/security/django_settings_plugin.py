...
class DjangoSettingsPlugin(BaseScanner):
    ...
    def _parse_settings(self, settings_path: Path) -> dict:
        """
    ...
    def _check_secret_key(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_debug_mode(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_allowed_hosts(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_secure_ssl_redirect(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_session_cookie_secure(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_csrf_cookie_secure(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_secure_hsts(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
    ...
    def _check_content_type_nosniff(self, settings_path: Path, settings_dict: dict) -> list[Finding]:
